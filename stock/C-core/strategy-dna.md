...
### Theory
When MACD crosses bullish AND RSI is in the "sweet spot" (40-70), the stock has momentum but isn't overbought. Ride the wave.

### Entry Conditions (ALL must be true)
- MACD line crosses above Signal line (bullish crossover)
- MACD histogram turns positive
- RSI(14) between 40 and 70 (momentum without overextension)
...
### Entry Conditions (ALL must be true)
- 10 EMA crosses above 50 EMA (bullish crossover within last 5 days)
- Price pulls back to touch or approach 10 EMA (within 0.5% of 10 EMA)
...
| Fast MA | 10 EMA |
| Slow MA | 50 EMA |
| Crossover Recency | Within 5 days |
| Pullback Zone | Within 0.5% of 10 EMA |
...
### Entry Conditions (ALL must be true)
- VIX closes 20% or more above its 10-day SMA
